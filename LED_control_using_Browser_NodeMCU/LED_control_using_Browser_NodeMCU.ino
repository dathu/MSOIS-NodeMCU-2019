...
const char* ssid = "dilse"; // SSID i.e. Service Set Identifier is the name of your WIFI
const char* password = "12340987"; // Your Wifi password, in case you have open network comment the whole statement.
